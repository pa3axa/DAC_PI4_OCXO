/* 
 ADF4350/51 PLL Frequency Init and beacon message.
  ...
  The Beacon 10Mhz ref frequency setting is controled by a DAC.
...
----------------------------------------------------------------
 ...
 I2C DAC values for PI4 @ 3400.925 Mhz
------------------------------------------------------
...
const uint16_t pi1 = 0x8092;
const uint16_t pi2 = 0x8593;  
const uint16_t pi3 = 0x8A92;  
...
//----------------------------------------------------------------------------------------
 ...
 PI0, case0 : 3.400.924.882,8125 Hz ;  0x7BB2 
 PI1, case1 : 3.400.925.117,1875 Hz ;  0x8092  
 PI2, case2 : 3.400.925.351,5625 Hz ;  0x8593  
 PI3, case3 : 3.400.925.585,9375 Hz ;  0x8A92 
...
delay(2000);                     // Wait for ADF5341 to powerup
  ...
  OSCCAL -= 3;                   // User calibration for correct PI4 timing
